...
if(isset($_POST['update_product'])){
   ...
   $image_folter = 'cake/'.$image;
   $old_image = $_POST['cake'];
...
<form action="" method="post" enctype="multipart/form-data">
   <img src="cake/<?php echo $fetch_products['image']; ?>" class="image"  alt="">
   <input type="hidden" value="<?php echo $fetch_products['id']; ?>" name="Update product ID">
   <input type="hidden" value="<?php echo $fetch_products['image']; ?>" name="update product image">
