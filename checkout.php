...
<section class="display-order">
    ...
    ?>
    <div class="grand-total">The Total Is <span>$<?php echo $grand_total; ?>/-</span></div>
</section>
    ...
    <form action="" method="POST">
        ...
        <div class="flex">
            ...
            <div class="inputBox">
                ...
                <input type="text" name="flat" placeholder="Enter The House Number ">
            </div>
            <div class="inputBox">
            ...
            <div class="inputBox">
                <span>Pin Code </span>
                <input type="number" min="0" name="pin_code" placeholder="Enter The Pin Code">
            </div>
        </div>
       <section>
